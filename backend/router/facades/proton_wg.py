...
class RouterProtonWG:
    ...
    def _rebuild_proton_wg_mangle_rules(self) -> None:
        ...
        script = "#!/bin/sh\n# Auto-generated by Flint VPN Manager — proton-wg mangle + DNS rules\n"
    ...
    def _rebuild_ipv6_mangle_rules(self) -> None:
        ...
        Since vpn-client is IPv4-only, Flint VPN Manager must manage the entire
        ...
        mangle_script = "#!/bin/sh\n# Auto-generated by Flint VPN Manager — IPv6 mangle rules\n\n"
        for cmd in cmds:
            mangle_script += cmd + "\n"
        ...
        fwd_script = "#!/bin/sh\n# Auto-generated by Flint VPN Manager — IPv6 forwarding rules\n\n"
        for cmd in fwd_cmds:
            fwd_script += cmd + "\n"
